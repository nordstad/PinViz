...
- Real-world device connection scenarios
- Power and ground distribution
- Performance with multiple devices
- Edge cases and error handling
- Full pipeline from prompt to SVG
"""
...
class TestRealWorldScenarios:
    """Tests for common real-world device connection scenarios."""

    def test_scenario_single_sensor(
        self, device_manager, parser, pin_assigner, connection_builder, temp_svg
    ):
    ...
    def test_scenario_mixed_protocols(
        self, device_manager, pin_assigner, connection_builder, temp_svg
    ):
    ...
    def test_scenario_spi_device(self, device_manager, pin_assigner, connection_builder, temp_svg):
    ...
    def test_scenario_home_automation(
        self, device_manager, pin_assigner, connection_builder, temp_svg
    ):
    ...
    def test_scenario_weather_station(
        self, device_manager, pin_assigner, connection_builder, temp_svg
    ):
...
class TestPowerGroundDistribution:
    """Tests for power and ground pin distribution across multiple devices."""

    def test_power_distribution(self, device_manager, pin_assigner):
    ...
    def test_ground_distribution(self, device_manager, pin_assigner):
...
class TestPerformance:
    """Performance tests for handling multiple devices."""

    def test_performance_multiple_devices(
        self, device_manager, pin_assigner, connection_builder, temp_svg
    ):
...
class TestEdgeCases:
    ...
    def test_edge_case_duplicate_devices(self, device_manager, pin_assigner):
    ...
    def test_edge_case_empty_device_list(self, pin_assigner, connection_builder):
